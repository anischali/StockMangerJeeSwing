...
public class GestPanel extends JFrame {
	...
	/**
	 * Initialise les menu de la session gestionnaire.
	 */
	...
	/**
	 * Initialise la partie qui va afficher la base de données.
	 */
	...
	/**
	 * Initialise les formulaires d'ajout des articles.
	 */
	...
	/**
	 * Affiche le menu Session gestionnaire.
	 */
	...
	/**
	 * Affiche le menu supprimer un article de Session gestionnaire.
	 */
	...
	/**
	 * Affiche le menu modifier un article de Session gestionnaire.
	 */
	...
	/**
	 * Affiche le menu Ajouter un article de Session gestionnaire.
	 */
	...
	/**
	 * Affiche le button ajouter un article de Session gestionnaire.
	 */
	...
	/**
	 * Affiche le button modifier un article de Session gestionnaire.
	 */
	...
	/**
	 * Affiche le button supprimer un article de Session gestionnaire.
	 */
	...
	/**
	 * Affiche la tableau refletant l'état du stock.
	 * @param articles un tableau de stock;
	 */
